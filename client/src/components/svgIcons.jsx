export const PlusIcon = ({ isFilled, size, fill, className }) => {
    return (
        <>
            {isFilled ? (
                <svg
                    ...
                    viewBox="0 0 50 50"
                    fill={fill}
                    className={`md:w-6 md:h-6 w-7 h-7 ${className}`}
                >
...
export const ArrowRight = ({ className }) => {
    return (
        <svg viewBox="0 0 21 13" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
